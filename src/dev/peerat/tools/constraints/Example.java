...
public class Example{
	...
	public static void main(String[] args) throws Exception{
		...
		BufferedReader fileReader = new BufferedReader(new FileReader(new File("./src/dev/peerat/tools/constraints/Example.java")));
	...
	class MyObjectConstraints implements SelfConstraints<MyObject>{
		...
		public void check(MyObject value){
			if(value.a == null && value.b == null) error("Can't be both null");
			if(value.a != null && value.b != null){
				if(value.b <= value.a) error("b need to be heigher than a");
				if(!value.bothPresent) reState(() -> {
